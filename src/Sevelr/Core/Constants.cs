...
public static class Constants
{
    ...
    public static class Paths
    {
        ...
        public static readonly string SnapshotsDir = Path.Combine(AppDataRoot, "snapshots");
        public static readonly string DatabasePath = Path.Combine(AppDataRoot, "sevelr.db");
    }
